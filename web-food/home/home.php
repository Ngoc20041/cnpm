...
<head>
    ...
    <script>
        window.onload = function() {
            var successParam = <?php echo isset($_GET['success']) ? $_GET['success'] : '0'; ?>;
            if (successParam == 1) {
...
<body>
    ...
    <header>
        ...
        <div id="khoi2">
            <nav class="navi">
                <a class="a" id="gach-chan-home" href="../home/home.php">Trang chủ</a>
                <a class="a" href="../page-food/page-food.php">Đồ ăn</a>
                <a class="a" href="../cart/page-cart.php">Giỏ hàng</a>
                <a class="a" href="../add-food/add-food.php">Cửa hàng của bạn</a>
            </nav>
        </div>
