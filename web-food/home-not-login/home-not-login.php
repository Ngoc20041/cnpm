...
<head>
    ...
    <link rel="stylesheet" href="home-not-login.css">
...
<body>
    <header>
        ...
        <div id="khoi2">
            <nav class="navi">
                <a class="a" id="gach-chan-home" href="home-not-login.php">Trang chủ</a>
                <a class="a" href="login/login.php">Đăng nhập</a>
                <a class="a" href="register/register.php">Đăng ký</a>

            </nav>
        </div>

        <div class="user-info">
            <p>Bạn chưa đăng nhập <span id="username">
            </p>
    ...
    <div id="banner">
        ...
        <div class="khhung-gioi-thieu">
            ...
            <div class="gioi-thieu">
                <p> 
                    Web chuyên cung cấp dịch vụ đặt đồ ăn uống, vì chỉ là phiên bản thử nghiệm nên web sẽ chưa phát triển chức năng. 
                  <br>  Web được xây dựng nhằm mục đích demo 1 website bán hàng.Dự án được phát triển bởi nhóm gồm 4 thành viên gồm: 
                  <ul class="list-designer">
                    <br>
                    <li>Phạm Thế Nhật</li>
                    <li>Bùi Bảo Ngọc</li>
                    <li>Nguyễn Thị Xuân Anh</li>
